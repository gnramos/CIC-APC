...
#ifndef UNB_CIC_APC_H /* Testa se o módulo já foi definido. */
#define UNB_CIC_APC_H /* Caso não tenha sido, defina agora, efetivamente
                         evitando a duplicação das funcionalidades definidas. */
...
#include "apc.h" /* Duplicação!

                    Mas há proteção definida, então o conflito é evitado... Mas
                    fica a questão de falta de atenção do programador com este
                    tipo de descuido (exceto neste arquivo que foi criado
                    especificamente para ilustrar este tipo de situação). */
